...
import { 
  ...
  ChefHat, Bell, ChevronDown, ChevronRight, Users, FileCheck2, FileSearch, ShieldCheck, ShoppingBag, ListChecks, Wrench, PackagePlus, ImageUp, Layers} from 'lucide-react';
    ...
    <div className="max-w-4xl mx-auto w-full min-w-0 pb-20">
      ...
      <div className="mb-10">
        ...
        >
          ...
          <motion.div variants={itemVariants} whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }} className="cursor-pointer">
            <Link to="/admin/global-items" className="bg-white p-5 rounded-2xl shadow-sm border border-neutral-100 hover:border-[#5c4033]/30 hover:shadow-md transition-all flex items-center gap-4 h-full">
              <div className="w-10 h-10 bg-neutral-100 text-[#5c4033] rounded-xl flex items-center justify-center shrink-0">
                <Layers size={20} />
              </div>
              <div>
                <h4 className="font-bold text-neutral-800">Global Items</h4>
                <p className="text-xs text-neutral-500">Shared product catalogue and per-store price, availability and menu overrides</p>
              </div>
            </Link>
          </motion.div>
          ...
          <motion.div variants={itemVariants} whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }} className="cursor-pointer">
            <Link to="/admin/product-images" className="bg-white p-5 rounded-2xl shadow-sm border border-amber-100 hover:border-amber-400 hover:shadow-md transition-all flex items-center gap-4 h-full">
              <div className="w-10 h-10 bg-amber-50 text-amber-700 rounded-xl flex items-center justify-center shrink-0">
                <ImageUp size={20} />
              </div>
              <div>
                <h4 className="font-bold text-neutral-800">Product Images</h4>
                <p className="text-xs text-neutral-500">Upload and manage sellable menu photos</p>
              </div>
            </Link>
          </motion.div>
          ...
          <motion.div variants={itemVariants} whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }} className="cursor-pointer">
            <Link to="/inventory/purchase-entry" className="bg-white p-5 rounded-2xl shadow-sm border border-neutral-100 hover:border-[#5c4033]/30 hover:shadow-md transition-all flex items-center gap-4 h-full">
              <div className="w-10 h-10 bg-neutral-100 text-[#5c4033] rounded-xl flex items-center justify-center shrink-0">
                <PackagePlus size={20} />
              </div>
              <div>
                <h4 className="font-bold text-neutral-800">Purchase Entry</h4>
                <p className="text-xs text-neutral-500">Post stock inward purchases</p>
              </div>
            </Link>
          </motion.div>
          ...
          <motion.div variants={itemVariants} whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }} className="cursor-pointer">
            <Link to="/admin/go-live-readiness" className="bg-emerald-50 p-5 rounded-2xl shadow-sm border border-emerald-200 hover:border-emerald-400 hover:shadow-md transition-all flex items-center gap-4 h-full">
              <div className="w-10 h-10 bg-white text-emerald-700 rounded-xl flex items-center justify-center shrink-0 border border-emerald-200">
                <ShieldCheck size={20} />
              </div>
              <div>
                <h4 className="font-bold text-neutral-800">Go-Live Readiness</h4>
                <p className="text-xs text-neutral-500">Store users, setup checks, and Firestore map</p>
              </div>
            </Link>
          </motion.div>
      ...
      >
        ...
        {showHistoricalTools && (
          ...
          >
            ...
            <Link to="/inventory/purchase-entry" className="bg-white p-4 rounded-xl shadow-sm border border-emerald-200 hover:border-emerald-400 transition-all flex items-center gap-3">
              <div className="w-8 h-8 bg-emerald-50 text-emerald-700 rounded-lg flex items-center justify-center shrink-0">
                <PackagePlus size={16} />
              </div>
              <div>
                <h4 className="font-bold text-sm text-neutral-800">Purchase Entry</h4>
                <p className="text-xs text-neutral-500">Post inward stock purchases</p>
              </div>
            </Link>
