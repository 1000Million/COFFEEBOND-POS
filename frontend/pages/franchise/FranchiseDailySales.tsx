...
import FranchisePasswordChangeGate from '../../components/franchise/FranchisePasswordChangeGate';
...
export default function FranchiseDailySales() {
  ...
  if (staffProfile.mustChangePassword) return <FranchisePasswordChangeGate />;
