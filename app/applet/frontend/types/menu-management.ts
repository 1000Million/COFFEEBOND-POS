...
export type BOMComponentType = 'RAW_INGREDIENT' | 'PREP_ITEM' | 'FINISHED_GOOD' | 'PACKAGING';
...
export type StockItemType = 'RAW_INGREDIENT' | 'PREP_ITEM' | 'FINISHED_GOOD' | 'PACKAGING';
